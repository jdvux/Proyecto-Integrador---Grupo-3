...
router.post('/createProduct', uploadProductImages, validateCreateProduct, productController.store);

router.get('/editProduct/:id', productController.edit);
router.put('/editProduct/:id', uploadProductImages, validateEditProduct, productController.update);
