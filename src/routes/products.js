...
router.post('/createProduct', upload, createProductValidations, productsController.store);

router.get('/editProduct/:id', productsController.edit);
router.put('/editProduct/:id', upload, editProductValidations, productsController.update);
